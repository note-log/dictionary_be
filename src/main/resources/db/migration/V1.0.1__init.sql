...
(
    ...
    is_audit bool not null COMMENT '是否通过审核' DEFAULT false,
    is_admin bool not null COMMENT '是否是管理员' DEFAULT false,
    is_banned bool not null COMMENT '是否禁用' DEFAULT false,
    is_deleted bool not null COMMENT '是否删除' DEFAULT false,
    login_time int not null COMMENT '登录次数' DEFAULT 0,
